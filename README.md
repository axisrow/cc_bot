...
- Служебный пинг «Monitoring started» уходит админу (`ADMIN_ID`) в личку при каждом старте, не в чат.
...
| `ADMIN_ID` | — | id админа для пинга «Monitoring started» при старте; без него пинг не шлётся |
